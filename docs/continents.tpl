...
<link rel="stylesheet" href="../site_libs/bootstrap-3.3.5/css/cerulean.min.css" rel="stylesheet" />
...
$( document ).ready(function(){
            ...
            var file=continentsDict[$("h1:first").attr("id")];
            $("#toc-level0 a").css("color","#126dce");
            $('a[href="#'+$("h1:first").attr("id")+'"]').hide()
            var docs=continentsArray;
            var docs_map=continentsArrayMap;
            var pos=continentsArray.indexOf(file);
            for (var a=pos;a>=0;a--){
